...
export const EmptyConstructor = ({ isHover = false } : TEmptyConstructorProps ) => (
    <div className={cn(
        ...
        <div className="flex flex-col items-center empty-constructor">
            ...
            <p className="mt-3 empty-constructor__text">Перетащите сюда</p>
            <p className="mt-1 text-gray-500 empty-constructor__text-small">любой элемент из левой панели</p>
        </div>
    </div>
);
